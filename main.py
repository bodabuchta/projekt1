...
while username in registrovani_uzivatele:
    print("Toto uživatelské jméno je již obsazeno, prosím vyplň znovu")
    username = input("Prosím zadej své uživatelské jméno: ")
else:
    password = input("Prosím zadej své heslo: ")
    print(username, password)
    registrovani_uzivatele.setdefault(username, password)
print("-" * 42)
